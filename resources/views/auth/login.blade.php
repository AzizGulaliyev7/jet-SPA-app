...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg  shadow-xl p-6">
        ...
        <h1 class="text-white text-3xl pt-8">Wel Come Back</h1>
        <h2 class="text-blue-300">Enter your credentioals below</h2>
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            @csrf

            <div class="relative">
                <label for="email" class="uppercase text-blue-500 txt-xs font-bold absolute pl-3 pt-2">E-mail</label>
            ...
            <div class="relative pt-3">
                <label for="password" class="uppercase text-blue-500 txt-xs font-bold absolute pl-3 pt-2">Password</label>
